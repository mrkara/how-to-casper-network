...
For this upgrade, to `casper-node v2.2.0`, the activation point is `Era 21500`, which will be approximately around Monday, March 16, 2026 at 13:33 UTC.
...
`Next Upgrade: {'activation_point': 21500, 'protocol_version': '2.2.0'}` `status` line:
...
See [the release notes](https://github.com/casper-network/casper-node/releases/tag/v2.2.0) for the details of the changes introduced with this upgrade.
