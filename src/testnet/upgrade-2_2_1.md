...
For this upgrade, to `casper-node v2.2.1`, the activation point is `Era 22223`, which will be approximately around Friday, May 15, 2026 at 18:30 UTC.
...
`Next Upgrade: {'activation_point': 22223, 'protocol_version': '2.2.1'}` `status` line:
...
See [the release notes](https://github.com/casper-network/casper-node/releases/tag/v2.2.1) for the details of the changes introduced with this upgrade.
