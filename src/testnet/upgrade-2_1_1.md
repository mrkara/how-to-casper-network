...
For this upgrade, to `casper-node v2.1.1`, the activation point is `Era 20275`, which will be approximately around Thursday, December 04, 2025 at 14:42 UTC.
...
`Next Upgrade: {'activation_point': 20275, 'protocol_version': '2.1.1'}` `status` line:
...
See [the release notes](https://github.com/casper-network/casper-node/releases/tag/v2.1.1) for the details of the changes introduced with this upgrade.
